...
1. `bash <(curl -s "[https://raw.githubusercontent.com/rafaelb128/ipv6-proxy-creator/main/scripts/install.sh](https://raw.githubusercontent.com/trieudao215/ipv6-proxy-creator/main/scripts/setup.sh)")`
